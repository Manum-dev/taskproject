...
- [x] Auto-Assignment and Workload calculation engine ($W_u$) implementation (`js/workloadEngine.js`)
...
- [x] UI components development (`index.html` & `js/app.js`):
  ...
  - [x] Team Workload Panel with progress meters and heuristic calculator
